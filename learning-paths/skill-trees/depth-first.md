...
### Branch 1: Foundations (Weeks 1-2)
...
- [Design Patterns](../domains/design-patterns.md) — All 23 patterns
- [System Design Fundamentals](../domains/system-design-fundamentals.md) — All problems
...
- **Monday:** Study 1 problem domain concept
- **Tuesday-Thursday:** Solve 3-4 problems in that domain
- **Friday:** Review and consolidate learning
- **Weekend:** Rest or review tough problems

---

## Success Tips

1. **Don't move until ready** — Solve ALL problems in current domain before next
2. **Revisit weekly** — Spend 30 min/week on previous domains to retain
3. **Build patterns library** — Keep a notebook of recurring techniques
4. **Implement from scratch** — Don't look at solutions until you try
5. **Explain aloud** — Talk through your approach to solidify understanding

---

## Alternative: Switch to Breadth-First
If after 4 weeks you feel overwhelmed, switch to [breadth-first.md](breadth-first.md).
...
- [All Domains](../domains/)
- [8-Week Comprehensive Track](../sequential-tracks/8-week-comprehensive.md)
