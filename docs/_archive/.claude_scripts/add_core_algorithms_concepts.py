#!/usr/bin/env python3
"""Add 30 comprehensive core algorithms concepts (5-34) to 02-core-algorithms."""
import os
output_dir = "docs/system_design/02-core-algorithms"
os.makedirs(output_dir, exist_ok=True)

CONCEPTS = {k: {"title": v, "scale": "Large-scale data processing, optimal time complexity",
        "overview": f"Comprehensive coverage of {v.lower()} with implementation, complexity analysis, and use cases."}
    for k, v in {
        "05_merge_sort": "Merge Sort Algorithm",
        "06_heap_sort": "Heap Sort Algorithm",
        "07_quicksort_variants": "QuickSort and Variants",
        "08_counting_sort": "Counting Sort and Radix Sort",
        "09_binary_search": "Binary Search and Variants",
        "10_interpolation_search": "Interpolation and Exponential Search",
        "11_pattern_matching_kmp": "KMP Pattern Matching Algorithm",
        "12_boyer_moore_search": "Boyer-Moore String Searching",
        "13_rabin_karp": "Rabin-Karp Rolling Hash",
        "14_aho_corasick": "Aho-Corasick Multi-Pattern Matching",
        "15_bfs_graph": "Breadth-First Search in Graphs",
        "16_dfs_graph": "Depth-First Search in Graphs",
        "17_dijkstra_algorithm": "Dijkstra's Shortest Path",
        "18_bellman_ford": "Bellman-Ford Algorithm",
        "19_floyd_warshall": "Floyd-Warshall All-Pairs Shortest Path",
        "20_topological_sort": "Topological Sorting",
        "21_minimum_spanning_tree": "Minimum Spanning Tree (Kruskal/Prim)",
        "22_union_find": "Union-Find Disjoint Set",
        "23_dynamic_programming": "Dynamic Programming Optimization",
        "24_greedy_algorithms": "Greedy Algorithm Design",
        "25_backtracking": "Backtracking and Search",
        "26_divide_conquer": "Divide and Conquer Strategy",
        "27_matrix_chain_multiply": "Matrix Chain Multiplication",
        "28_edit_distance": "Edit Distance and LCS",
        "29_coin_change": "Coin Change Problems",
        "30_knapsack_problem": "Knapsack and Optimization",
        "31_graph_coloring": "Graph Coloring Algorithms",
        "32_trie_data_structure": "Trie Data Structure",
        "33_segment_tree": "Segment Tree and Range Queries",
        "34_suffix_array": "Suffix Arrays and Indexes",
    }.items()}
...
print("💾 Creating 30 new core algorithms concepts (5-34)...")
print("=" * 70)
for idx, (key, data) in enumerate(CONCEPTS.items(), start=5):
    generate_concept_file(idx, key, data)
print("=" * 70)
print(f"✨ Created 30 comprehensive algorithms concepts!")
