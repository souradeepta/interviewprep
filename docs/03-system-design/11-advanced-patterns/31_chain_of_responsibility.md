...
Chain of Responsibility provides a proven solution to recurring design problems.

## Problem

Common issues Chain of Responsibility solves:
...
- Chain of Responsibility used in popular frameworks
