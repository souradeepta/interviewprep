...
Strategy Pattern provides a proven solution to recurring design problems.

## Problem

Common issues Strategy Pattern solves:
...
- Strategy Pattern used in popular frameworks
