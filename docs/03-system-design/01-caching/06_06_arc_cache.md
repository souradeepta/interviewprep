...
ARC combines LRU and LFU benefits, maintaining separate lists for recent and frequent items. It adapts dynamically between recency and frequency based on workload, achieving better hit ratios than pure LRU or LFU. Used in storage systems and databases for superior performance.

**Scale Metrics:**
- 100M+ entries, adaptive to workload, 99%+ hit ratio
