# Cache Pollution and Eviction Prediction

## System Overview

Cache pollution occurs when less-useful data evicts useful data, reducing hit ratio. One-time sequential scans can pollute entire cache. Techniques like scan-resistant replacement policies (CLOCK-Pro) and priority-based eviction protect working set from pollution.

**Scale Metrics:**
- 100M+ entries, 20-30% performance impact from pollution
