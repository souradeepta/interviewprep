# Geohashing and Spatial Caching

## System Overview

Geohashing converts latitude/longitude into sortable strings, enabling efficient spatial caching and range queries. Geohash length determines precision; longer hashes more precise but more cache misses. Used in location services, maps, and geo-distributed systems.

**Scale Metrics:**
- Geographic data, sub-millisecond range queries
