...
app = FastAPI(title="Amazon Inventory Warehouse", version="1.0.0")
...
```java
package com.example.amazon_inventory_warehouse.model;
...
```java
package com.example.amazon_inventory_warehouse.repository;

import com.example.amazon_inventory_warehouse.model.Post;
...
```java
package com.example.amazon_inventory_warehouse.service;

import com.example.amazon_inventory_warehouse.model.Post;
import com.example.amazon_inventory_warehouse.repository.PostRepository;
...
```java
package com.example.amazon_inventory_warehouse.controller;

import com.example.amazon_inventory_warehouse.model.Post;
import com.example.amazon_inventory_warehouse.service.PostService;
import lombok.RequiredArgsConstructor;
import lombok.extern.slf4j.Slf4j;
...
```java
package com.example.amazon_inventory_warehouse.config;
...
Amazon Inventory Warehouse is a mission-critical system serving N/A users globally.
