...
app = FastAPI(title="Square Pos", version="1.0.0")
...
```java
package com.example.square_pos.model;
...
```java
package com.example.square_pos.repository;

import com.example.square_pos.model.Post;
...
```java
package com.example.square_pos.service;

import com.example.square_pos.model.Post;
import com.example.square_pos.repository.PostRepository;
...
```java
package com.example.square_pos.controller;

import com.example.square_pos.model.Post;
import com.example.square_pos.service.PostService;
import lombok.RequiredArgsConstructor;
import lombok.extern.slf4j.Slf4j;
...
```java
package com.example.square_pos.config;
...
Square Pos is a mission-critical system serving 100M+ users globally.
...
- Concurrent users: 30M+ DAU, 300K+ RPS peak
...
**Technical Metrics:**
- P50 latency: < 50ms
- P99 latency: P99 < 100ms for payment
- P99.9 latency: < 1s
- Availability: 99.99%
- Error rate: < 0.1%
- Cache hit ratio: > 95%
...
2. Maintains SLOs: P99 < 100ms for payment latency, 99.99% availability
