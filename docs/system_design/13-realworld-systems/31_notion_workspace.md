...
app = FastAPI(title="Notion Workspace", version="1.0.0")
...
```java
package com.example.notion_workspace.model;
...
```java
package com.example.notion_workspace.repository;

import com.example.notion_workspace.model.Post;
...
```java
package com.example.notion_workspace.service;

import com.example.notion_workspace.model.Post;
import com.example.notion_workspace.repository.PostRepository;
...
```java
package com.example.notion_workspace.controller;

import com.example.notion_workspace.model.Post;
import com.example.notion_workspace.service.PostService;
import lombok.RequiredArgsConstructor;
import lombok.extern.slf4j.Slf4j;
...
```java
package com.example.notion_workspace.config;
