...
app = FastAPI(title="Youtube Video Platform", version="1.0.0")
...
```java
package com.example.youtube_video_platform.model;
...
```java
package com.example.youtube_video_platform.repository;

import com.example.youtube_video_platform.model.Post;
...
```java
package com.example.youtube_video_platform.service;

import com.example.youtube_video_platform.model.Post;
import com.example.youtube_video_platform.repository.PostRepository;
...
```java
package com.example.youtube_video_platform.controller;

import com.example.youtube_video_platform.model.Post;
import com.example.youtube_video_platform.service.PostService;
import lombok.RequiredArgsConstructor;
import lombok.extern.slf4j.Slf4j;
...
```java
package com.example.youtube_video_platform.config;
...
Youtube Video Platform is a mission-critical system serving N/A users globally.
