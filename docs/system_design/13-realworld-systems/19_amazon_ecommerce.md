...
app = FastAPI(title="Amazon Ecommerce", version="1.0.0")
...
```java
package com.example.amazon_ecommerce.model;
...
```java
package com.example.amazon_ecommerce.repository;

import com.example.amazon_ecommerce.model.Post;
...
```java
package com.example.amazon_ecommerce.service;

import com.example.amazon_ecommerce.model.Post;
import com.example.amazon_ecommerce.repository.PostRepository;
...
```java
package com.example.amazon_ecommerce.controller;

import com.example.amazon_ecommerce.model.Post;
import com.example.amazon_ecommerce.service.PostService;
import lombok.RequiredArgsConstructor;
import lombok.extern.slf4j.Slf4j;
...
```java
package com.example.amazon_ecommerce.config;
...
Amazon Ecommerce is a mission-critical system serving N/A users globally.
