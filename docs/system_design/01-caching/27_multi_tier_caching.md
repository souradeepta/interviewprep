...
Multi-tier caching (L1: process-local, L2: in-region distributed, L3: global distributed) provides graduated latency and consistency guarantees. L1 misses fallback to L2; L2 misses fallback to L3. Tradeoff: memory/cost vs. latency. Requires coherence between tiers.

**Scale Metrics:**
- L1/L2/L3 caches, 100x performance variance across tiers
