# Probabilistic Expiration and Jittered TTL

## System Overview

Instead of fixed TTL causing simultaneous expirations, probabilistic expiration staggers refreshes. Items expire randomly around nominal TTL, spreading recalculation load over time. Jittered TTL adds randomness to prevent synchronization. Simple but effective defense against cache stampede.

**Scale Metrics:**
- Prevent thundering herd, 10-100x reduction in spike traffic
