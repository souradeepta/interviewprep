# Tiered Memory Systems and Heterogeneous Storage

## System Overview

Tiered memory combines fast (DRAM) and slow (SSD, HDD) storage, automatically moving hot data to fast tiers. Key-value stores use tiered caching (L1: memory, L2: SSD, L3: HDD) for cost-effectiveness. Intelligent tiering policies optimize cost-performance tradeoff.

**Scale Metrics:**
- 10x performance variance, automatic tiering, petabyte-scale
