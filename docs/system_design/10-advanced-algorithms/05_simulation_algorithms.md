...
2. What happens if the random number generator (RNG) fails?
3. How to ensure statistical accuracy with bounded variance in this system?
...
|-----------|-----------|-------|
| Sample draw | O(1) | Inverse-CDF or rejection sampling |
