...
Microservices Architecture provides a proven solution to recurring design problems.

## Problem

Common issues Microservices Architecture solves:
...
- Microservices Architecture used in popular frameworks
