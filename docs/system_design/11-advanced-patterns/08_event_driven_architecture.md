...
Event-Driven Architecture provides a proven solution to recurring design problems.

## Problem

Common issues Event-Driven Architecture solves:
...
- Event-Driven Architecture used in popular frameworks
