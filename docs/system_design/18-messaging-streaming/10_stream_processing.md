...
**Scale Metrics:**
- **Throughput:** Processing trillion events/day with sub-second latency
- **Key Components:** Stateless ops, Aggregations, Joins, Windows
- **Primary Use Case:** Real-time analytics, fraud detection, recommendations
