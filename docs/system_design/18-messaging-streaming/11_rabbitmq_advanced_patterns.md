...
Advanced RabbitMQ patterns: message routing, dead-letter exchanges, priority queues, TTL, lazy queues.
...
| Aspect | RabbitMQ Advanced Patterns | Alternative 1 | Alternative 2 |
|--------|-----------|---------------|---------------|
| Latency | - | - | - |
| Throughput | - | - | - |
| Complexity | - | - | - |
