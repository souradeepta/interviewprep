...
**Scale Metrics:**
- **Throughput:** 100B+ messages/day, 1M+ messages/sec, petabytes of data
- **Key Components:** Brokers, Zookeeper, Producers, Consumers, Topics, Partitions
- **Primary Use Case:** Event streaming, log aggregation, real-time analytics
