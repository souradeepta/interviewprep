...
**Scale Metrics:**
- **Throughput:** Guaranteeing exactly-once delivery with database
- **Key Components:** Outbox table, Polling, CDC-based polling, Deduplication
- **Primary Use Case:** Order processing, event publishing, dual writes
