...
**Scale Metrics:**
- **Throughput:** Preserving order for billions of messages
- **Key Components:** Per-partition ordering, Sequence numbers, Session windows
- **Primary Use Case:** Financial systems, order processing, event sequencing
